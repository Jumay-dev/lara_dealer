...
<body>
    ...
    <div class="content--wrapper">
        <span class="point--description username">Здравствуйте, <?php echo e($user->surname . ' ' . $user->patronymic); ?>!</span>
        <div class="text--main">
        ...
        <div class="bank-details text-division">
            <span class="point--title">Название клиники: </span> <span class="point--description"><?php echo e($clinic->name); ?></span> <br>
            <span class="point--title">ИНН клиники:  </span><span class="point--description"><?php echo e($clinic->inn); ?></span> <br>
            <span class="point--title">Адрес: </span><span class="point--description"><?php echo e($clinic->address); ?></span>
        </div>
...
<?php /**PATH C:\Projects\lara_dealer\resources\views/projectadded.blade.php ENDPATH**/ ?>